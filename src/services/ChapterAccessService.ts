...
export interface IChapterAccessService {
    readChapter(req: CustomRequest, res: Response): Promise<void>; 
}

export class ChapterAccessService implements IChapterAccessService {
